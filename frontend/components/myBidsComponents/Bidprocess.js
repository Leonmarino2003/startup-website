...
export default function Bidprocess({ status }) {
    ...
    <div className={styles.body}>
      ...
      <div className={styles.bidDesc}>
        ...
        <div>
          ...
          <p>{translations.bidProgressBidPlacedDesc}</p>
          </div>
        </Link>
        <Link>
        <div>
          {translations.bidProgressBidSent}
          <p>{translations.bidProgressBidSentDesc}</p>
          </div>
        </Link>
        <Link>
        <div>
          {translations.bidProgressBidRecieved}
          <p>{translations.bidProgressBidRecievedDesc}</p>
          </div>
        </Link>
        <Link>{translations.bidProgressDecision}</Link>
      </div>
    </div>
  );
}
